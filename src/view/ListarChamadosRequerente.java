 ...
 * @author joelc
 */
public class ListarChamadosRequerente extends javax.swing.JInternalFrame {
 /*   public int getRowCount(); */
    
    /**
     * Creates new form CadastroDeChamado
     */
    public ListarChamadosRequerente() {
        initComponents();
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(105, 450, Short.MAX_VALUE))
    ...
    public void popularTabelaChamado(){
           ...
           ChamadoController ch =  new ChamadoController();
            ...
            for(LinhasDaTBL dado : ch.chamadosRequerente(usuario_id)){
                    modelo.addRow(new Object[]{
              dado.getChamadoID(),
              dado.getChamadoTitulo(),
              dado.getSituacaoChamado(),
